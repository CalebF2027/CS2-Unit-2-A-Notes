public class Main {
   ...
   public static void main(String []args) {
      ...
      System.out.println("Let's see if you can take the road test...");
      if (age >= 16) {
